...
type Repository[T Entity] interface {
	...
	Select(ctx context.Context, fields []string) Repository[T]
	FindBy(ctx context.Context, fs ...any) ([]T, error)
	All(ctx context.Context) ([]T, error)
	FindByWithRelations(ctx context.Context, fs ...any) ([]T, error)
	FindWithRelations(ctx context.Context, id any) (*T, error)
	FindFirstBy(ctx context.Context, fs ...any) (*T, error)
	...
	Update(ctx context.Context, t *T, fs ...any) error
	UpdateAll(ctx context.Context, t []*T) error
